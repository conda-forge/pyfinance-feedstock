About pyfinance-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyfinance-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6390&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyfinance-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyfinance` can be installed with `conda`:
...
```
mamba install pyfinance
```

It is possible to list all of the versions of `pyfinance` available on your platform with `conda`:
...
```
mamba search pyfinance --channel conda-forge
```
...
mamba repoquery search pyfinance --channel conda-forge

# List packages depending on `pyfinance`:
mamba repoquery whoneeds pyfinance --channel conda-forge

# List dependencies of `pyfinance`:
mamba repoquery depends pyfinance --channel conda-forge
```
